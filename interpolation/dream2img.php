...
try {
    ...
    $user_inputs = [
        ...
        "want_music" => $_POST['want_music'],
        "want_voice" => $_POST['want_voice'],
        "audio_description" => $_POST['audio_description'] ?? '',
        "voice_description" => $_POST['voice_description'] ?? '',
        "voice_name" => $_POST['voice_name'] ?? '',
        "specified_num_scenes" => intval($_POST['specified_num_scenes']),
        "want_auto_split" => isset($_POST['want_auto_split']) && 
                           ($_POST['want_auto_split'] === 'true' || $_POST['want_auto_split'] === '1' || $_POST['want_auto_split'] === true)
    ];

    // Process JSON data for complex objects
    $user_inputs["voice_details"] = !empty($_POST['voice_details']) ? json_decode($_POST['voice_details'], true) : [];
    $user_inputs["voice_info"] = !empty($_POST['voice_info']) ? json_decode($_POST['voice_info'], true) : [];
